...
public OnPluginStart()
{
	...
	l4d_climb_team = CreateConVar("l4d_climb_team", "2", "  1:enable for survivor and infected, 2:enable for survivor, 3:enable for infected ", FCVAR_PLUGIN);	
	...
	ReadyEnable = FindConVar("l4d_climb_enable");

	ResetAllState();
}
public void OnRoundIsLive()
{
	ReadyEnable.IntValue = 0;
}
